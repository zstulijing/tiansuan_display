        ...
        <template slot-scope="scope">
          <el-row style="width: 80%;">
            ...
            <el-progress :text-inside="true" :stroke-width="15" 
             :percentage="parseFloat(scope.row.time_15)" status="exception" style="width:80%;float:right"/>
          </el-row>
          <el-row style="width: 80%;">
            <span>∠30°</span>
            <el-progress :text-inside="true" :stroke-width="15" 
            :percentage="parseFloat(scope.row.time_30)" status="warning" style="margin-top: 1px;width:80%;float:right"/>
          </el-row>
          <el-row style="width: 80%;">
            <span>∠50°</span>
            <el-progress :text-inside="true" :stroke-width="15" 
              :percentage="parseFloat(scope.row.time_50)" status="success" style="margin-top: 1px;width:80%;float:right"/>
          </el-row>
