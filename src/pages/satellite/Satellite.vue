...
<script>
import TempLine from '@/pages/satellite/charts/TempLine.vue'
import UsageLine from '@/pages/satellite/charts/UsageLine.vue'
import MemoryPie from '@/pages/satellite/charts/MemoryPie.vue'
import CpuPie from '@/pages/satellite/charts/CpuPie.vue'
import TransactionTable from '@/pages/satellite/charts/TransactionTable.vue'
