<template>
  <div ref="refChart" id="world" style="width:100%;height:100%;" />
</template>
...
export default {
  ...
  data() {
    return {
      ...
      baseTexture: require('@/assets/images/world/world.jpg'),
      heightTexture: require('@/assets/images/world/world.jpg'),
      night: require('@/assets/images/world/night.jpg'),
      cloud: require('@/assets/images/world/clouds2.png'),
      stars: require('@/assets/images/world/starfield.jpg'),
      ...
      sate_TLE:{
        ...
        "北邮二号": [
          "1 64049U 25103B   25148.84379426  .00006075  00000+0  32845-3 0  9999",
          "2 64049  97.4191 224.2184 0004258  90.4639 264.7081 15.15031576  1761"
        ],
        "北邮三号": [
          "1 64050U 25103C   25148.84372732  .00006342  00000+0  34259-3 0  9993",
          "2 64050  97.4100 224.7122 0004421  88.1919 276.9820 15.15043503  1766"
        ],
        "天算9号": [
